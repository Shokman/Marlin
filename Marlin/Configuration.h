...
// 314 is Argento's hot end thermistor MF58
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160.30, 160.30, 8076, 1880.0}
//#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 45}    // (mm/sec)
//#define DEFAULT_MAX_ACCELERATION      {9000,9000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
#define DEFAULT_MAX_ACCELERATION      {8000,8000,100,5000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
