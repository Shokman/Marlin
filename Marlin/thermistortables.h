...
#endif
#if (THERMISTORHEATER_0 == 314) || (THERMISTORHEATER_1 == 314) || (THERMISTORHEATER_2 == 314) || (THERMISTORBED == 314)
// 100k Thermistor MF58 // UTILIZADo por el Argento //Ultima actualizacion 24-feb-2014 by Lucas Chiesa
